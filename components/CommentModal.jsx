            ...
            >
                ...
                <div className="comment-modal-footer">
                    <div className="comment-modal-footer-left">
                        <button className='comment-modalfoot-left-btn comment-modalfoot-left-emoji'><Smile width={20} /></button>

                        <button className='comment-modalfoot-left-btn comment-modalfoot-left-images'><ImageIcon width={20} /></button>

                        <button className='comment-modalfoot-left-btn comment-modalfoot-left-gif'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill='#545454' id="gif">
