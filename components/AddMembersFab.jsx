  ...
  return (
    <AnimatePresence>
      {open && (
        ...
        >
          <motion.div
            className="absolute inset-0 bg-white/50 backdrop-blur-xl"
            onClick={handleClose}
          />
                ...
                >
                  <div className="flex items-center justify-between px-5 pt-5">
                    <div className="flex items-center gap-2">
                      ...
                      <h2 className="text-black">Add members</h2>
                    </div>
                    <button
                      onClick={handleClose}
                  ...
                  <div className="mt-4 flex items-center justify-end gap-1.5 border-t border-black/5 bg-black/[0.02] px-5 py-3">
                    <button
                      onClick={handleClose}
                      className="h-9 rounded-lg px-3 text-sm text-black/60 transition hover:bg-black/5 hover:text-black"
                    >
                      Cancel
                    </button>
                    <button
                      ...
                      className="h-9 rounded-lg bg-black px-4 text-sm text-white transition hover:bg-black/85 disabled:cursor-not-allowed disabled:bg-black/25"
                    >
