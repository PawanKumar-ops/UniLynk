...
const ShareModal = ({ isOpen, onClose, postContent, postUrl }) => {
  ...
  const showQuickPanelEmpty = !quickPanelLoading && quickPanelContacts.length === 0;
          ...
          <div className="share-modal-body">
            <div className="share-section">
              ...
              <div className="share-apps">
                <button type="button" className="share-modal-app-button" onClick={() => handleShareToApp('whatsapp')}>
                ...
                <button type="button" className="share-modal-app-button" onClick={() => handleShareToApp('facebook')}>
                ...
                <button type="button" className="share-modal-app-button" onClick={() => handleShareToApp('twitter')}>
                ...
                <button type="button" className="share-modal-app-button" onClick={() => handleShareToApp('telegram')}>
                ...
                <button type="button" className="share-modal-app-button" onClick={() => handleShareToApp('linkedin')}>
                ...
                <button type="button" className="share-modal-app-button" onClick={() => handleShareToApp('email')}>
          ...
          <div className="share-modal-side-box-content">
            ...
            {quickPanelContacts.length > 0 ? (
              <div className="share-modal-top-users" role="list">
                {quickPanelContacts.map((contact, index) => {
                  const contactId = contact?.id || contact?.email || `contact-${index}`;
