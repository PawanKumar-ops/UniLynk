      ...
      <div className="clubmain">
        ...
        <div className="clubcontentcont">
          ...
          <div className="clubcontent">
            ...
            {active === 1 && <div className="tab-panel"><h2 className="section-title">Past Activities</h2></div>}
            {active === 2 && <div className="tab-panel"><h2 className="section-title">Upcoming Events</h2></div>}
          </div>
        </div>
      </div>
